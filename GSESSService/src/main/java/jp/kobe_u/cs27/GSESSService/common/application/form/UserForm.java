...
import javax.validation.constraints.Email; // 文字列は整形式のメールアドレスである必要がある
...
public class UserForm {
    /** ユーザID */
    @Pattern(regexp = "[0-9a-zA-Z_\\-]+") // 指定された正規表現と一致する必要がある javax.validation.constraints.Pattern
    ...
    @Email // 文字列は整形式のメールアドレスである必要があります javax.validation.constraints.Email
    ...
    public User toEntity() {
        return new User(this.getUid(), this.getNickname(), this.getEmail());
    }
}